...
train_file = 'edhmodel_train_set'
test_file = 'edhmodel_test_set'
...
# Decision Tree
DT = DecisionTreeClassifier(min_samples_split=10, min_samples_leaf=4, max_depth=10, random_state=1)
...
FFNN = KerasClassifier(build_fn=create_keras_model, optimizer='adam', learning_rate=0.001, epochs=200, batch_size=32, verbose=0)
FFNN.fit(X_train, y_train)
FFNN.model.save('edh_FFNN.h5')
