...
#sql = "select distinct id,pdbid,zinc_x,zinc_y,zinc_z,chainid_a from zinc_predict_site234_2 where selected_site is true order by id "
...
for i in data:
    ...
    pdbfile  = data_dir + '/' + pdb_code + "_nb_result" +"/pdb2"+ pdb_code + ".ent"
